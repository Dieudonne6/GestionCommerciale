  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      background: #f4f4f4; /* Couleur de fond neutre */
      text-align: center;
    }
    ...
    .field input:focus {
      border-color: #00b34b; /* Couleur de focus */
    ...
    form button:hover {
      background: #00b34b; /* Bleu plus foncé au survol */
    }
