                            ...
                            <tbody>
                                @foreach ($magasins as $magasin)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <!-- Bouton Détails -->
                                            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#detailsModal{{ $magasin->idMag }}">
                                                Détails
                                            </button>
                                            <!-- Bouton Modifier -->
                                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editModal{{ $magasin->idMag }}">
                                                Modifier
                                            </button>
                                            <!-- Bouton Supprimer -->
                                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $magasin->idMag }}">
                                                Supprimer
                                            </button>
                                        </td>
                                    </tr>
