                    ...
                    <div class="col-auto">
                        <div class="col-auto">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#addUserModal"><i class="fa-solid fa-plus me-1"></i> Ajouter un
                                utilisateur</button>
                        </div><!--end col-->
                    </div><!--end col-->
                </div><!--end row-->
                                        ...
                                        <form action="{{ route('users.modifie', $user->idU) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label for="roleID" class="form-label">Rôle</label>
                                                        <select name="roleID" data-user-id="{{ $user->id }}"
                                                            class="role-select">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('users.supprime', $user->idU) }}" method="POST">
                                            ...
                                            @method('DELETE')
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteUserModalLabel">Supprimer utilisateur
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
