                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row d-flex justify-content-center ">
                                        ...
                                        <div class="col-12 col-md-6 align-self-center text-start text-md-end">
                                            <button type="button"
                                                class="btn btn-outline-secondary btn-sm px-2 mt-2 mt-md-0 ">View
                                                Report</button>
                                        </div><!--end col-->
                                    </div><!--end row-->
                                </div><!--end card-body-->
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-danger-subtle text-danger px-2">Out of Stock</span>
                                            </td>
                                            <td>
                                                <a href="#"><i class="las la-pen text-secondary fs-18"></i></a>
                                                <a href="#"><i
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <p class="text-secondary text-truncate mb-0 rounded mt-2 text-center">To review the new order
                                by Jems. <a href="#" class="text-primary text-decoration-underline">detail</a> </p>
                        </div><!--end card-body-->
                    </div><!--end card-->
                </div> <!--end col-->
            </div><!--end row-->
                                                    ...
                                                    <div class="flex-grow-1 text-truncate">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="progress bg-primary-subtle w-100"
                                                                style="height:5px;" role="progressbar"
                                                    ...
                                                    <div class="flex-grow-1 text-truncate">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="progress bg-primary-subtle w-100"
                                                                ...
                                                                aria-label="Success example" aria-valuenow="25"
                                                                aria-valuemin="0" aria-valuemax="100">
                                                                <div class="progress-bar bg-primary" style="width: 48%">
                                                                </div>
                                                            </div>
