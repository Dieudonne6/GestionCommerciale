                                ...
                                <tbody>
                                    @foreach ($categories as $category)
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('categories.destroy', $category->idC) }}"
                                                    ...
                                                    data-bs-target="#deleteModal{{ $category->idC }}" method="POST"
                                        ...
                                        <div class="modal fade" id="editCategoryModal{{ $category->idC }}"
                                            tabindex="-1" aria-labelledby="editCategoryModalLabel{{ $category->idC }}"
                                            aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="POST"
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="editCategoryName" class="form-label">Nom de la
                                                                    catégorie</label>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="editCategoryImage" class="form-label">Nouvelle
                                                                    image</label>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="currentCategoryImage" class="form-label">Image
                                                                    actuelle</label>
                                                                <br>
                                                                <img src="{{ asset('storage/' . $category->imgC) }}"
                                                                    class="img-fluid"
                                        ...
                                        <div class="modal fade" id="deleteModal{{ $category->idC }}" tabindex="-1"
                                            aria-labelledby="deleteModal{{ $category->idC }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
