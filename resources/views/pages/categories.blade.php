...
<div class="page-wrapper">
  ...
  <div class="page-content">
    <div class="container-xxl"> 
        <h1 class="mb-5">Gestion des Categories</h1>
      <div class="row">
        <div class="col-12">
          <div class="card">
          @if(session('success'))
                ...
                <table class="table mb-0 checkbox-all" id="datatable_1">
                  ...
                  @foreach($categories as $category)
                    <tr class="text-center">
                      ...
                      <td>{{ $category->NomC }}</td>
                      <td class="ps-0">
                        <img src="{{ asset('storage/' . $category->imgC) }}" alt="{{ $category->NomC }}" height="40">
                      </td>
                      <td>
                        <!-- Formulaire pour supprimer une catégorie -->
    <form action="{{ route('categories.destroy', $category->idC) }}" method="POST" style="display:inline-block;">
      @csrf
      @method('DELETE')
